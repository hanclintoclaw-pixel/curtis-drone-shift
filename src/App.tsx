  ...
  return {
    ...
    log: [
      ...
      },
      {
        ...
        nuyenDelta: -300,
        qualityDelta: 1,
        note: 'The final report is clear enough to update Curtis with a player-facing gear entry and no hidden benefits. Project modifiers: comfortable carry is easier to document for daily-use limits, reducing this closeout TN by 1; documented sleeves and edge guards preserve cleaner repair and maintenance paperwork for Day 14.',
      },
    ],
    reportCopied: false,
  }
